...
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel" style="border-radius: 8px">
            ...
            <div class="x_content">
                <form id="formEditCall" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <table class="table">
                                <tr>
                                    ...
                                    <td><span class="fa fa-trash" href="#"></span></td>
                                </tr>
                                <tr>
                                    <td>2.</td>
                                    <td>test.jpg</td>
                    ...
                    <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                            <button class="btn btn-primary" type="button" value="Save" id="btnSaveLead" form="formEditCall">Cancel</button>
                            <button class="btn btn-success" type="submit" value="Submit" form="formEditCall">Save</button>
                        </div>
                    </div>
                </form>
            </div>
