...
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel" style="border-radius: 8px">
            ...
            <div class="x_content">
                <form id="formEditMeet" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select style="border-radius: 6px; color: #495057;" id="namaprospect" name="namaprospect" class="form-control" data-error=".errorTxt2" disabled>
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <div class="row">
                                <div class="col-md-2 col-sm-2 ">
                                    <input type="text" id="meet_ke" name="meet_ke" class="form-control" style="border-radius: 6px" data-error=".errorTxt13" disabled>
                                </div>
                    ...
                    <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                            <button class="btn btn-primary" type="button" value="Save" id="btnSaveLead" form="formEditMeet">Save</button>
                            <button class="btn btn-success" type="submit" value="Submit" form="formEditMeet">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
