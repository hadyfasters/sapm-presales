                            ...
                            <div class="x_content">
                                ...
                                <div class="item form-group">
                                    <div class="col-md-3 col-sm-3 offset-md-3">
                                        <button class="btn btn-primary" type="button" value="reject" id="btnRejectCall" form="formInputCall">Reject</button>
                                        <button class="btn btn-success" type="submit" value="approve" form="formApproveCall">Approve</button>
                                    </div>
                                </div>
                            </div>
                        </div>
