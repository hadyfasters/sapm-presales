...
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel" style="border-radius: 8px">
            ...
            <div class="x_content">
                <form id="formEditLead" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <input type="text" id="datelead" name="datelead" class="datepicker form-control" style="border-radius: 6px" data-error=".errorTxt13" placeholder="dd/mm/yyyy">
                                </div>
                                <label class="col-form-label col-md-1 col-sm-1 label-align" for="timelead">Time</label>
                                <div class="col-md-4 col-sm-4">
                                    <input type="text" id="timelead" name="timelead" class="timepicker form-control" style="border-radius: 6px" data-error=".errorTxt13" placeholder="HH:mm">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-6 ">
