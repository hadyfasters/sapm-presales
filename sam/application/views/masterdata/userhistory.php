...
<div class="right_col" role="main">
    ...
    <div class="tile_count">
        <div class="col-md-12 col-sm-12 tile_stats_count">
            <div class="count">Audit Trail - User History</div>
        </div>
    </div>
</div>
                ...
                <form>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="daterange1" name="daterange1" class="form-control" style="border-radius: 6px" placeholder="DD/MM/YYYY - DD/MM/YYYY">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="npp">NPP</label>
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="npp" name="npp" class="form-control" style="border-radius: 6px" placeholder="NPP">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Name</label>
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="name" name="name" class="form-control" style="border-radius: 6px" placeholder="Nama">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <table id="dataUserHistory" class="table table-striped table-bordered" width="100%">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Tanggal</th>
                                        ...
                                        <th>Fungsi</th>
                                        <th>Nama (Before)</th>
                                        <th>Wilayah (Before)</th>
                                        <th>Cabang (Before)</th>
                                        <th>Jabatan (Before)</th>
                                        <th>Nama (After)</th>
                                        <th>Wilayah (After)</th>
                                        <th>Cabang (After)</th>
                                        <th>Jabatan (After)</th>
