...
class Menu extends SAM_Controller {
	...
	{
        $this->data['content'] = 'menumanagement/list-menu';
    ...
    public function add()
    {
        $this->data['content'] = 'menumanagement/input-menu';
        $this->data['javascriptLoad'] = array(
            1 => 'assets/build/js/menu.js',
    ...
    {
        $this->data['content'] = 'menumanagement/edit-menu';
        $this->data['javascriptLoad'] = array(
            1 => 'assets/build/js/menu.js',
            2 => 'assets/build/js/jquery.validate.min.js'
        );
