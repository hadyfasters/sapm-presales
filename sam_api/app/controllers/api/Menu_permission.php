			...
			if($this->is_verified){
				...
				if($this->is_login){
					if(is_array($res->menu)){
						...
						$getOldData = $this->M_menu_permission->getDataByPosition($res->userposition);

						if($getOldData){
							// Delete Old Data
							$delete = $this->M_menu_permission->removeAll($res->userposition);
						}
